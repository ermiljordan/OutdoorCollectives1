<?php
 /**
 *
 * @package   Outdoor Collective Functionality
 * @author    ermiljordan <ermiljordan6@email.com>
 * @license   GPL-2.0+
 * @copyright Outdoor Collective 2018
 *
 * @wordpress-plugin
 * Plugin Name: Outdoor Collective Functionality
